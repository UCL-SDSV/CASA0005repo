...
shape <- st_read("/Users/xuanshi/SDSV/CASA0005/GIS01/statistical-gis-boundaries-london/ESRI/London_Borough_Excluding_MHW.shp")
```
...
mycsv <-  read_csv("/Users/xuanshi/SDSV/CASA0005/GIS01/fly-tipping-borough.csv",skip=1)  
```
...
```{r cache=TRUE, message=FALSE}
shape %>%
  st_write(.,"/Users/xuanshi/SDSV/CASA0005/GIS01/Rwk1.gpkg",
...
con <- dbConnect(RSQLite::SQLite(),dbname="/Users/xuanshi/SDSV/CASA0005/GIS01/Rwk1.gpkg")
```
